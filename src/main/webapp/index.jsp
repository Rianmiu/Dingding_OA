		...
		<aside id="sidebar_left">
			...
			<div class="user-info">
				<div class="media">
					...
					<div class="media-body">
						<h5 class="media-heading mt5 mbn fw700 cursor">${sessionScope.emp.realname}<span class="caret ml5"></span></h5>
						<div class="media-links fs11">
							<a href="#">${sessionScope.emp.d.dname}</a><i class="fa fa-circle text-muted fs3 p8 va-m"></i>
							<a href="#" onclick="javascript:if(confirm('是否退出登录?'))window.location.href='logout'">退出</a>
						</div>
					</div>
				</div>
			</div>
			<div class="sidebar-menu">
				<ul class="nav sidebar-nav">
					<li>
						<a class="accordion-toggle" href="departs" target="right"> <span class="glyphicons glyphicons-user"></span><span
							 class="sidebar-title">部门管理</span><span class="caret"></span></a>
					</li>
					<li>
						<a class="accordion-toggle" href="users" target="right"><span class="glyphicons glyphicons-user"></span><span
							 class="sidebar-title">用户管理</span><span class="caret"></span></a>
					</li>

					<li>
						<a class="accordion-toggle" href="leave.jsp" target="right"><span class="glyphicons glyphicons-user"></span><span
